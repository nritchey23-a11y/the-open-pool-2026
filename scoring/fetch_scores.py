#!/usr/bin/env python3
"""
Fetch live Open Championship scores from ESPN and compute pool standings.
...
AUGUSTA_PARS = [4, 4, 4, 3, 4, 4, 3, 4, 4, 4, 4, 3, 4, 5, 3, 4, 5, 4]  # Royal Birkdale par 70 - verified

# ── Teams ─────────────────────────────────────────────────────
TEAMS = {
    'Nick':         ['Scottie Scheffler', 'Shane Lowry', 'Justin Thomas', 'Sepp Straka', 'Cameron Smith', 'Nick Taylor'],
    'JB':           ['Rory McIlroy', 'Si Woo Kim', 'Patrick Cantlay', 'Kurt Kitayama', 'Maverick McNealy', 'Tom McKibbin'],
    'Berit':        ['Tommy Fleetwood', 'Russell Henley', 'Tom Kim', 'Corey Conners', 'Nicolai Hojgaard', 'Ryan Gerard'],
    'Ian':          ['Matt Fitzpatrick', 'Min Woo Lee', 'Patrick Reed', 'Hideki Matsuyama', 'Adam Scott', 'Sahith Theegala'],
    'Wheats':       ['Cameron Young', 'Robert MacIntyre', 'Rickie Fowler', 'Kristoffer Reitan', 'Brian Harman', 'Michael Thorbjornsen'],
    'Pat':          ['Jon Rahm', 'Tyrrell Hatton', 'Aaron Rai', 'Harris English', 'Max Homa', 'Sungjae Im'],
    'Trizz':        ['Xander Schauffele', 'Viktor Hovland', 'J.J. Spaun', 'Joaquin Niemann', 'Ryan Fox', 'J.T. Poston'],
    'Ben':          ['Ludvig Aberg', 'Sam Burns', 'Bryson DeChambeau', 'Alex Fitzpatrick', 'Eugenio Chacarra', 'Keegan Bradley'],
    'Justin (Doc)': ['Chris Gotterup', 'Wyndham Clark', 'Ben Griffin', 'Akshay Bhatia', 'Gary Woodland', 'Marco Penge'],
    'Kelly':        ['Collin Morikawa', 'Justin Rose', 'Jordan Spieth', 'Brooks Koepka', 'Jason Day', 'Harry Hall'],
}
...
def main():
    print("Fetching live ESPN Open Championship data...", file=sys.stderr)
    ...
    out_path = "/home/user/workspace/theopen-tracker/pool_scores.json"
